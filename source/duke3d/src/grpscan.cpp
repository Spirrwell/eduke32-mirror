...
static internalgrpinfo_t const internalgrpfiles[] =
{
    ...
    { "Duke it out in D.C.",                   DUKEDC_REPACK_CRC,  8410187, GAMEFLAG_DUKE|GAMEFLAG_ADDON, DUKE15_CRC, "DUKEDC.CON", NULL},
    ...
    { "Duke Caribbean: Life's a Beach",        VACA_REPACK_CRC, 22397273, GAMEFLAG_DUKE|GAMEFLAG_ADDON, DUKE15_CRC, "VACATION.CON", NULL},
    ...
    { "Duke!ZONE II",                          DZ2_PP_REPACK_CRC,  3186656, GAMEFLAG_DUKE|GAMEFLAG_ADDON, DUKE15_CRC, "DZ-GAME.CON", NULL},
    ...
    { "Duke Nukem's Penthouse Paradise",       PENTP_ZOOM_CRC,  4247491, GAMEFLAG_DUKE|GAMEFLAG_ADDON, DUKE15_CRC, "PPAKGAME.CON", NULL}, // ZOOM Platform repacked .grp
